...
export const ImageIcon: React.FC<{ className?: string }> = ({ className = 'h-4 w-4' }) => (
...
export const TargetIcon: React.FC<{ className?: string }> = ({ className = '' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-8 w-8 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
        ...
        <line x1="2" y1="12" x2="4" y2="12" stroke="currentColor" />
        <line x1="20" y1="12" x2="22" y2="12" stroke="currentColor" />
    </svg>
);

export const SpinnerIcon: React.FC<{ className?: string }> = ({ className = '' }) => (
  <svg className={`animate-spin h-5 w-5 text-brand-primary ${className}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
    <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
  </svg>
);

export const CancelGenerationIcon: React.FC<{ className?: string; isLarge?: boolean }> = ({ className = '', isLarge = false }) => (
    <div className={`relative h-5 w-5 transition-transform duration-300 ease-in-out ${isLarge ? 'scale-125' : ''} ${className}`}>
        <svg className="absolute inset-0 h-full w-full animate-spin" fill="none" viewBox="0 0 24 24">
            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
        </svg>
...
export const PendingIcon: React.FC<{ className?: string }> = ({ className = '' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 text-gray-300 dark:text-gray-600 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
export const MultiImageIcon: React.FC<{ className?: string }> = ({ className = '' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z" />
    </svg>
);

export const ImageFusionIcon: React.FC<{ className?: string }> = ({ className = '' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M16 4h2a2 2 0 012 2v2" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M16 20h2a2 2 0 002-2v-2" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v12" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6" />
    </svg>
);

export const SceneBuildIcon: React.FC<{ className?: string }> = ({ className = '' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.59 14.37a6 6 0 01-5.84 7.38v-4.8m5.84-2.58a14.98 14.98 0 006.16-12.12A14.98 14.98 0 009.63 2.25a14.98 14.98 0 00-5.84 7.38m5.84 2.58a14.98 14.98 0 007.5-10.63M3.75 21V9h3.75V3h9v6h3.75v12H3.75z" />
    </svg>
);

export const ClearInputIcon: React.FC<{ className?: string }> = ({ className = '' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const MagicWandIcon: React.FC<{ className?: string }> = ({ className = '' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 00-3.48-2.14-3 3 0 00-2.14 3.48l1.37 5.39a.75.75 0 001.31-.33l.24-1.201a3.753 3.753 0 015.7-2.427l.159.298a.75.75 0 001.31.33l1.37-5.39a3 3 0 00-3.48-2.14 3 3 0 00-2.14 3.48l-.24 1.201z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a.75.75 0 01.75.75v.01a.75.75 0 01-.75.75a.75.75 0 01-.75-.75v-.01a.75.75 0 01.75-.75zm.75 1.5a.75.75 0 01.75.75v.01a.75.75 0 01-.75.75a.75.75 0 01-.75-.75v-.01a.75.75 0 01.75-.75zm-3.75-1.5a.75.75 0 01.75.75v.01a.75.75 0 01-.75.75a.75.75 0 01-.75-.75v-.01a.75.75 0 01.75-.75z" />
  </svg>
);
...
export const GoogleIcon: React.FC<{ className?: string }> = ({ className = '' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${className}`} viewBox="0 0 24 24" fill="currentColor">
        <path d="M21.35,11.1H12.18V13.83H18.69C18.36,17.64 15.19,19.27 12.19,19.27C8.36,19.27 5,16.25 5,12C5,7.9 8.2,5 12,5C14.6,5 16.1,6.3 17.4,7.4L17.4,7.4L19.3,5.5C17.1,3.5 14.8,2 12,2C6.4,2 2,6.5 2,12C2,17.5 6.4,22 12,22C17.6,22 21.5,18.2 21.5,12.3C21.5,11.7 21.45,11.4 21.35,11.1Z" />
    </svg>
);
...
export const EyeSlashIcon: React.FC<{ className?: string }> = ({ className = '' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${className}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243l-4.243-4.243zM12 17.25a5.25 5.25 0 005.25-5.25m-10.5 0a5.25 5.25 0 015.25-5.25m3.75 3.75l-4.243 4.243M3 3l18 18" />
    </svg>
);